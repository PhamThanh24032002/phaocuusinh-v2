...
namespace DemoCallAPI.Controllers
{
    ...
    public class DepartmentsController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<IActionResult> GetDepartment([FromRoute] string id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutDepartment([FromRoute] string id, [FromBody] Department department)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        {
            return _context.Departments.Any(e => e.DepartId == id);
        }
    }
}